...
class EditableCell extends Component {
  ...
  save = e => {
    const { record, onSave, formconfig } = this.props
  ...
  renderCell = form => {
    ...
    const formItem = (
      <Form.Item style={{ margin: 0 }}>
        {/* {
          (type == 'input' || type == 'number') && form.getFieldDecorator(fieldName, { rules, initialValue })(
  ...
  render () {
    ...
    // const padding = editable ? '6px 16px' : '16px 16px'
