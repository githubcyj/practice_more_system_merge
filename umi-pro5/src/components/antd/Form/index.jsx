...
//     if(config.fieldName) {
//         return (
//             <FormItem name={config.fieldName} rules={config.rules} initialValues={config.initialValue}>
//                 { config.instance 
//           ? config.instance
...
//               <Button loading={this.props.loading} type="primary" onClick={this.handleSearch} style={{ marginRight: 10, display: this.props.search? 'inline-block' : 'none' }}>查询</Button>
//               <Button loading={this.props.loading} onClick={this.handleReset} style={{ marginRight: 10, display: this.props.reset? 'inline-block' : 'none' }}>重置</Button>

//               <Button loading={this.props.loading} onClick={this.props.handleCancel} style={{ marginRight: 10, display: this.props.cancel? 'inline-block' : 'none' }}>{this.props.cancelText || '取消'}</Button>
//               <Button loading={this.props.loading} type="primary" htmlType="submit" style={{ display: this.props.submit? 'inline-block' : 'none' }} className="login-form-button">{this.props.submitText || '提交'}</Button>
//               <Button loading={this.props.loading} type="link" style={{ display: this.props.showCollapse ? 'inline-block' : 'none' }} onClick={this.handleOnShowMoreCondition}>
//                 {
...
//           }    
//           <Button loading={this.props.loading} type="primary" htmlType="submit" className="login-form-button" style={{ display: btnDisplay, marginRight: 10}}>
//             {this.props.searchButton ? this.props.searchButton : '查询' } 
//           </Button>
//           <Button loading={this.props.loading} className="login-form-button" style={{ display: resetDisplay }} onClick={this.handleReset}>
